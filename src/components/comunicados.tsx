...
export function Comunicados(){
    return(
        <a href="#">
            <div className="text-sky-500 bg-sky-50 rounded-lg border-transparent border justify-center items-center flex-col py-4 px-6 w-72 h-76 shadow-2xl hover:border hover:border-sky-500">
